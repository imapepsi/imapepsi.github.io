...
In this lesson we're going to learn about functions.

### Setting Up

1. Open the Python Shell app: `IDLE.app`
2. Click `File` in the file bar and click `New File` to create a new python file
3. Save this file as `lesson07.py` in the folder you'd like to keep your python scripts/programs
...
Create a new file called `lesson07-exercise.py`. In this file, write a program that does the following:
